...
const output = spawnOrFail("sam", [
  ...
  `InstanceTypeSupportedAvailabilityZones=${instanceTypeAzs}`,
  `PrivateSubnet1CIDR=10.192.16.0/24`,
  `PrivateSubnet2CIDR=10.192.17.0/24`,
  `PublicSubnet1CIDR=10.192.14.0/24`,
  `PublicSubnet2CIDR=10.192.15.0/24`,
  "--capabilities",
  "CAPABILITY_IAM",
  "--region",
  `${region}`,
