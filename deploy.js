...
const output = spawnOrFail("sam", [
  ...
  `${stack}`,
  "--parameter-overrides",
  `EnvironmentName=recording-environment-v2`,
  `ECSContainerName=recording-container`,
  ...
  `InstanceTypeSupportedAvailabilityZones=us-east-1d,us-east-1f`,
  `VpcCIDR=10.193.0.0/16`,
  `PublicSubnetsCIDR=10.193.10.0/24,10.193.11.0/24`,
  `PrivateSubnetsCIDR=10.193.20.0/24,10.193.21.0/24`,
  "--capabilities",
  "CAPABILITY_IAM",
  "--region",
  `${region}`,
